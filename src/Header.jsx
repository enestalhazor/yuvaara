...
function Header() {
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-stone-200 select-none">
                <TextLogo />
                <div className="flex items-center gap-2 ml-auto">
                    <div className="relative flex items-center">
                        {isFiltered && (
                            <button
                                ...
                                className="text-stone-400 hover:text-stone-950 transition-colors mr-1"
                            >
                                <FilterX size={16} />
                            </button>
                        )}
                    ...
                    <div className="relative flex flex-col items-center">
                        <img
                            ...
                            className="w-8 h-8 rounded-full cursor-pointer ring-2 ring-amber-600/30 hover:ring-amber-600 transition-all flex-shrink-0"
